...
Classifier = (function() {
  ...
  Classifier.prototype.create_match_sequence = function(path, definition) {
    var identifiers, key, optional_keys, request_entity, required_keys, response_entity, sequence, specs, type, val, _i, _len;
    identifiers = {};
    specs = {};
    ...
    if (request_entity = definition.request_entity) {
      identifiers.ContentType = specs.ContentType = this.schema[request_entity].mediaType;
    } else {
      identifiers.ContentType = specs.ContentType = "[any]";
    }
    if (response_entity = definition.response_entity) {
      identifiers.Accept = specs.Accept = this.schema[response_entity].mediaType;

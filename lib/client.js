...
var Client, SchemaManager, Shred, patchboard_api, patchboard_resources;
...
Client = (function() {
  ...
  function Client(options) {
    ...
    this.resources = {};
    this.resource_definitions = {};
    for (key in patchboard_resources) {
      value = patchboard_resources[key];
      this.resource_definitions[key] = value;
    }
    _ref = options.resources;
    for (key in _ref) {
      value = _ref[key];
      this.resource_definitions[key] = value;
    }
    ...
    _ref2 = this.resource_definitions;
  ...
  Client.prototype.resourcify = function(constructor, resource_type) {
    ...
    if (definition = this.resource_definitions[resource_type]) {
      this.define_actions(constructor, definition.actions);
    }
    return constructor;
  };
  ...
  Client.prototype.resource_methods = {
    ...
    authorize: function(type, action) {
      return this.client.authorizer.call(this, type, action);
    }
  };
  ...
  Client.prototype.request_creator = function(name, definition) {
    ...
    return function(name, options) {
      var credential, handler, key, request, resource, status, value, _base, _i, _len, _ref, _ref1, _ref2;
      resource = this;
      request = {
        url: resource.url,
        method: method,
      ...
      _ref1 = [202, 204, "error", "request_error", "response"];
      ...
      (_base = request.on).request_error || (_base.request_error = function(err) {
        throw err;
      });
      _ref2 = options.on;
      for (status in _ref2) {

...
Client = (function() {
    ...
    for (resource_type in _ref2) {
      ...
      for (id in _ref3) {
        ...
        if (name === resource_type) {
          constructor = this.resourcify(constructor, resource_type);
  ...
  Client.prototype.request_creator = function(name, definition) {
    ...
    return function(name, options) {
      var credential, handler, key, request, status, value, _i, _len, _ref, _ref1, _ref2;
      request = {
        url: this.url,
        method: method,
        headers: {},
      ...
      if (authorization) {
        credential = this.authorize(authorization, name);

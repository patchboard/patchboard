...
Client = (function() {
  ...
  function Client(options) {
    var definition, key, resource_type, schema, value, _ref, _ref1, _ref2;
    this.shred = new Shred();
    this.munged_schema = options.schema;
    ...
    for (resource_type in _ref2) {
      ...
      if (schema = this.schema_manager.names[resource_type]) {
